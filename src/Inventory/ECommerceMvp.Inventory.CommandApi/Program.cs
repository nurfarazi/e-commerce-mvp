...
builder.Services.AddSingleton<IRepository<ECommerceMvp.Inventory.Domain.InventoryItem, string>, InventoryRepository>();
builder.Services.AddSingleton<ICommandDispatcher, CommandDispatcher>();

// Command handlers
builder.Services.AddScoped<ICommandHandler<SetStockCommand, SetStockResponse>, SetStockCommandHandler>();
builder.Services.AddScoped<ICommandHandler<ValidateStockCommand, ValidateStockResponse>, ValidateStockCommandHandler>();
builder.Services.AddScoped<ICommandHandler<DeductStockForOrderCommand, DeductStockForOrderResponse>, DeductStockForOrderCommandHandler>();
...
Log.Information("Inventory CommandApi starting on port 5002");
app.Run();
